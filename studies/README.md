...
Esta pasta concentra cursos, desafios, anotacoes e fundamentos. A proposta e separar pratica guiada de projetos aplicados.

| Area | Caminho | Conteudo |
| --- | --- | --- |
| Linguagens | `linguagens/` | Estudos de Python, PHP, JavaScript, HTML, CSS, SQL, Java e C++. |
| W3School | `w3school/` | Exercicios iniciais e repeticao de fundamentos. |
