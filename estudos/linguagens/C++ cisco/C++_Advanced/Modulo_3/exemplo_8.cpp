...
int main() {
    ...
    if (equal(v1.begin(), v1.end(), l1.begin())) {
        cout << "Collections v1 and l1 are equal!\n";
    } else {
        cout << "Collections v1 and l1 are NOT equal!\n";
    }
    cout << endl;
    ...
    if (equal(v2.begin(), v2.end(), l2.begin())) {
        cout << "Collections v2 and l2 are equal!\n";
    } else {
        cout << "Collections v2 and l2 are NOT equal!\n";
    }
    cout << endl;
