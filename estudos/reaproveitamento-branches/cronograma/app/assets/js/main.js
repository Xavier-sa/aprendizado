const cronograma = [
    ...
    },
    {
        ...
        quizzes: [
            ...
            {
                question: "O que um bom portfólio deve conter?",
                options: [
                    "Projetos práticos e código-fonte organizado",
                    "Somente certificados de cursos",
                    "Apenas textos explicando o que o autor sabe",
                    "Links de redes sociais"
                ],
                answer: 0,
                explanation: "Projetos práticos com código bem estruturado mostram suas habilidades de forma concreta."
            },
            {
                question: "Qual é a principal vantagem de revisar seus estudos semanalmente?",
                options: [
                    "Fixar o conhecimento e identificar pontos fracos",
                    "Evitar estudar assuntos novos",
                    "Memorizar tudo sem prática",
                    "Economizar tempo sem revisar"
                ],
                answer: 0,
                explanation: "Revisar ajuda a consolidar o aprendizado e melhorar o entendimento dos temas estudados."
            },
            {
                question: "Como o GitHub pode fortalecer o seu portfólio?",
                options: [
                    "Exibindo sua frequência e contribuições reais",
                    "Servindo apenas como um backup de arquivos",
                    "Mostrando fotos e descrições pessoais",
                    "Não tem influência alguma"
                ],
                answer: 0,
                explanation: "Manter projetos ativos e commits constantes no GitHub demonstra constância e prática real."
            },
            {
                question: "O que diferencia um portfólio técnico de um currículo tradicional?",
                options: [
                    "O portfólio mostra resultados práticos, enquanto o currículo lista informações",
                    "Nenhuma diferença significativa",
                    "O currículo tem mais peso que o portfólio",
                    "O portfólio serve apenas para designers"
                ],
                answer: 0,
                explanation: "O portfólio exibe projetos e habilidades em ação, complementando o currículo."
            },
            {
                question: "Qual é uma boa prática ao adicionar novos projetos ao portfólio?",
                options: [
                    "Descrever o objetivo, tecnologias usadas e aprendizados obtidos",
                    "Adicionar apenas o código-fonte",
                    "Publicar sem revisar os erros",
                    "Esconder projetos simples"
                ],
                answer: 0,
                explanation: "Descrever o processo mostra maturidade técnica e reflexiva no desenvolvimento."
            }
        ]
    }
