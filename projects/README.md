...
Esta pasta concentra projetos aplicados, sistemas pequenos e experimentos que ja possuem mais contexto do que um exercicio isolado.
...
| Organizando | `organizando/` | Arquivos historicos de organizacao, automacao e prototipos. |

## Padrao

- Cada projeto deve ter um README proprio quando possivel.
- Nomes de pastas usam letras minusculas e hifen.
- Arquivos internos antigos podem ser preservados quando ajudam a mostrar evolucao.
