...
main ()
{
  ...
  if (found != v1.end ())
    {
      cout << "Sequence: 7 7 7 " << *found << " has been found at position: "
  ...
  if (found != v1.end ())
    {
      cout << "Sequence: 2 2 " << *found << " has been found at position: " <<
	distance (v1.begin (), found) << endl;
    }
  else
    {
  ...
  if (founds != l1.end ())
    {
      cout << "Sequence: A A " << *founds << " has been found at position: "
